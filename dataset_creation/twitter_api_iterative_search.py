...
# Details of what to search for, what to remove from the results and what label to add
'''
url = 'theguardian.com'
label = '1'
...
try:
    results = client.cursor(client.search, q=url + ' AND -filter:retweets',tweet_mode='extended',lang='en',count=100)
